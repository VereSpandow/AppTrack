...
{
    public class MemberCountSalesRepReportViewModel
    {
        public List<MemberCountSalesRepReport> MemberCountSalesRepReportList { get; set; }
        public List<MemberCountSalesRepReportXTab> MemberCountSalesRepReportListXTab { get; set; }
        ...
        public IEnumerable<System.Web.Mvc.SelectListItem> SearchSalesRepList { get; set; }

    
    }
    public class MemberCountSalesRepReport
    {
    ...
    public class MemberCountSalesRepReportXTab
    {
        public int SponsorID { get; set; }
        public string DisplayName { get; set; }
        public string PeriodName { get; set; }
