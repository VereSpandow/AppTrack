...
{
    public class MemberCountReportViewModel
    {
        public List<MemberCountReport> MemberCountReportList { get; set; }
        public List<MemberCountReportXTab> MemberCountReportListXTab { get; set; }
    ...
    public class MemberCountReport
    {
    ...
    public class MemberCountReportXTab
    {
        public int StoreID { get; set; }
        public string StoreName { get; set; }
        public string PeriodName { get; set; }
    ...
    public class StackBarData
    {
        ...
        public StackBarData(int iD, string month, string measure, decimal value)
        {
            ID = iD ;
            Month = month;
            Measure = measure;
