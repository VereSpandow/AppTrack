...
namespace AppTrack.Controllers
{
    ...
    public class SalesPoPReportController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            {
                model.SalesPoPReportList = db.Database.SqlQuery<SalesPoPReport>("exec dbo.[LB_GetMemberVendorSalesTrendsV2] @MemberID, @VendorID",
        ...
        public ActionResult Index(string searchCustID = "", int searchVendorID = 0, int searchPeriodID = 0, string submit = "submit")
        {
            ...
            using (var db = new DevProvidentIDOCEntities())
            {
                ...
                model.SalesPoPReportList = db.Database.SqlQuery<SalesPoPReport>("exec dbo.[LB_GetMemberVendorSalesTrendsV2] @MemberID, @VendorID, @MaxPeriodID",
                new SqlParameter("@MemberID", intCustID),
                new SqlParameter("@VendorID", searchVendorID),
        ...
        public JsonResult LineChart(int searchCustID = 0, int searchVendorID = 0)
        {
            ...
            using (var db = new DevProvidentIDOCEntities())
            {
                model = db.Database.SqlQuery<SalesPoPReport>("exec dbo.[LB_GetMemberVendorSalesTotal] @MemberID, @VendorID",
