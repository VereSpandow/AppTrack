...
namespace AppTrack.Controllers
{
    ...
    public class CustomerNotesController : BaseController
    {
        ...
        public ActionResult TaskList()
        {
            ...
            int searchAssignedToID = AdminID;
            ...
            IEnumerable<System.Web.Mvc.SelectListItem> searchAssignedToList = DataHelper.GetAdminSelectList(true);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult AddNoteInit([Bind(Include = "NoteType, SearchCustID, SearchActivityID, SearchAssignedToID, SearchStartDate, SearchEndDate, SearchScheduledStartDate, SearchScheduledEndDate, SearchCompletedStartDate, SearchCompletedEndDate, SearchNoteType, SearchCommType, SearchCommDirection, SearchPhrase, SearchNoteStatus")] CustomerNoteUpdateViewModel CustomerNoteUpdateViewModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult AddNote([Bind(Include = "CustID, ActivityID, NoteType, CommType, CommDirection, NoteText, ScheduledDate, AssignedTo, SearchCustID, SearchActivityID, SearchAssignedToID, SearchStartDate, SearchEndDate, SearchScheduledStartDate, SearchScheduledEndDate, SearchCompletedStartDate, SearchCompletedEndDate, SearchNoteType, SearchCommType, SearchCommDirection, SearchPhrase, SearchNoteStatus")] CustomerNoteUpdateViewModel CustomerNoteUpdateViewModel)
        {
            ViewBag.Success = "N";
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult EditNoteInit([Bind(Include = "NoteID, SearchCustID, SearchActivityID, SearchAssignedToID, SearchStartDate, SearchEndDate, SearchScheduledStartDate, SearchScheduledEndDate, SearchCompletedStartDate, SearchCompletedEndDate, SearchNoteType, SearchCommType, SearchCommDirection, SearchPhrase, SearchNoteStatus")] CustomerNoteUpdateViewModel CustomerNoteUpdateViewModel)
        {
            ModelState.Remove("NoteText");
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult EditNote([Bind(Include = "NoteID, CustID, OwnerID, ActivityID, Notetype, CommType, CommDirection, NoteText, ScheduledDate, EndDate, AssignedTo, AssignedDate, Status, SearchCustID, SearchActivityID, SearchAssignedToID, SearchStartDate, SearchEndDate, SearchScheduledStartDate, SearchScheduledEndDate, SearchCompletedStartDate, SearchCompletedEndDate, SearchNoteType, SearchCommType, SearchCommDirection, SearchPhrase, SearchNoteStatus")] CustomerNoteUpdateViewModel CustomerNoteUpdateViewModel)
        {
            ViewBag.Success = "N";
